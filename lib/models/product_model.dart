 ...
 final String color;
 final String image;
const Product({required this.id,required this.name, required this.desc,required this.price, required this.color,required this.image});
static const List<Product> products=[
  Product(
  id: 1,
name: 'iPhone 12 Pro',
desc: "Aple iPhone 12th generation",
price: 999,
color: "#33505a",
